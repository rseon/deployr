...
class DeployController extends AbstractController
{
    ...
    protected function handleSingleFile()
    {
        ...
        $this->db->insertLog(Tools::sanitize($_POST['commit_author']), Tools::sanitize($_POST['commit_message'] ?? ''), $success, [$filename]);
    ...
    protected function handleMultipleFiles()
    {
        ...
        $this->db->insertLog(Tools::sanitize($_POST['commit_author']), Tools::sanitize($_POST['commit_message'] ?? ''), $success, $filenames);
